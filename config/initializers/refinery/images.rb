...
Refinery::Images.configure do |config|
  ...
  config.user_image_sizes = {:small=>"624x408>", :medium=>"1400x528>", :large=>"1400x930>"}
  ...
  # config.dragonfly_secret = "f0f338c8b7bf3e1806060b1312d350fdf496b488a0c19522"
  # If you decide to trust file extensions replace :ext below with :format
  # config.dragonfly_url_format = "/system/images/:job/:basename.:ext"
  # config.dragonfly_url_host = ""
  # config.datastore_root_path = "/Users/jameslutley/Sites/jamesandni/public/system/refinery/images"
